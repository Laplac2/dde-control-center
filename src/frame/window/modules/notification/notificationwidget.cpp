    ...
    , m_model(model)
{
    ...
    m_systemListView->setViewportMargins(QMargins(0, 0, 8, 0)); // 二级菜单，系统通知选项距离右边边界15px     左，上，右，下
    ...
    m_softwareListView->setViewportMargins(QMargins(0, 0, 9, 0)); // 二级菜单，应用通知选项距离右边边界15px   左，上，右，下
